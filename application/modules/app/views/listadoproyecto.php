...
<html class="no-js" lang="es">
    ...
    <body class="page-template-onecolumn-page-php listadoproyecto">
            ...
            <div class="row">
                <div class="infoContainer TEXT-LEFT">
                    ...
                    <div class="titulo">
                        ...
                        <a href="javascript:;" class="moreinfo open" style="display: none;">+ info</a>
                        <a href="javascript:;" class="moreinfo cerr"><i class="fa fa-times" aria-hidden="true"></i> CERRAR</a>

                    </div>

                    <div class="descripcion___ listado">
